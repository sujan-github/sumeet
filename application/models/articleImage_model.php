...
class articleImage_model extends CI_Model
{
    public function get_all($query = null)
    {
        ...
        $query = $this->db->get('articleImage');
    ...
    {
        if ($this->db->delete('articleImage', array('Id' => $id))) {
            return true;
        } else {
            return false;
        }
